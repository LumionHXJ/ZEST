...
def parse_manifest(manifest):
    audio_files = []
    codes = []
    #reqd_files = ["0011_000021", "0012_000022", "0013_000025", 
    #"0014_000032", "0015_000034", "0016_000035", "0017_000038",
    # "0018_000043", "0019_000023", "0020_000047"]
...
class CodeDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.multispkr:
            feats['spkr'] = np.load(os.path.join(config['EASE']['embedding'], emo_file_name))
